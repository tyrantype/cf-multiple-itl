...
fetch("../api/total-dashboard-user.php")
.then(response => response.json())
.then(result => {
...
.then(response => response.json())
.then(result => {
    document.getElementById("fullName").innerText = result.data[0].full_name
    document.getElementById("username").innerText = result.data[0].username
    document.getElementById("gender").innerText = result.data[0].gender
    document.getElementById("address").innerText = result.data[0].address
    document.getElementById("dateOfBirth").innerText = result.data[0].date_of_birth
})